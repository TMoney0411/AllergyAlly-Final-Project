...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
  ...
  $severity_symptoms = htmlspecialchars(trim($_POST['severity_symptoms']));
  ...
  else
  {
    ...
    if ($stmt)
    {
      $stmt->bind_param("ssssss", $name, $username, $createPassword, $allergies_str, $other, $severity_symptoms);
      if ($stmt->execute())
      {
    ...
    {
      error_log("Database prepare failed: " . $stmt->error);
    }
    $conn->close();
  }
}
  ...
  <head>
    ...
    <form id="form" method="post" action="create_account.php">
        ...
        <fieldset>
          ...
          <input type="checkbox" id="nuts1" name="allergies[]" value="peanuts"> <label for="nuts1">Peanuts</label>
          <input type="checkbox" id="nuts2" name="allergies[]" value="treenuts"> <label for="nuts2">Treenuts</label>
          <input type="checkbox" id="nuts3" name="allergies[]" value="seeds"> <label for="nuts3">Seeds</label>
          ...
          <label for="other">Other: </label> <input type="text" id="other" name="other">
        </fieldset><br><br>
        ...
        <fieldset>
          ...
          <label for="severity_symptoms">Allergy Description: </label> <input type="text" id="severity_symptoms" name="severity_symptoms"><br>
        </fieldset><br>
